...
For these plots I modified the `visualize.py` file so that it generated a bar graph of the results and stored them as a png file. The graphs above display the frequency of `#coronavirus` and `#코로나바이러스` for each country and language. 
